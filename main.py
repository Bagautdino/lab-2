...
dialog = {
    ...
    'questions': ('Выберите жанр?' + p + e,
                  'Какая минимальная оценка?' + e,
                  'Количество отзывов больше чем...' + e,
                  'Чего не должно быть' + p + e,
                  'Формат' + p + e,
                  'Сколько минимум эпизодов?' + e,
                  'Должно быть закончено?' + e,
                  'От какого года?' + e,
                  'До какого года?' + e,
                  'Какой сезон?' + p + e,
                  'Студия?' + p + e
